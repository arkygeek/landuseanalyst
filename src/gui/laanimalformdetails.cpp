...
LaAnimalFormDetails::LaAnimalFormDetails(QWidget* parent, Qt::WFlags fl)
  : QDialog(parent,fl) 
{
...
LaAnimalFormDetails::~LaAnimalFormDetails()
{
  writeSettings();
}

void LaAnimalFormDetails::readSettings()
{
...
void LaAnimalFormDetails::writeSettings()
{
  QSettings mySettings;
...
void LaAnimalFormDetails::on_pushButtonLoad_clicked()
{
  //
}

void LaAnimalFormDetails::on_pushButtonSave_clicked()
{
  //
}
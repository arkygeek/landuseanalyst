...
LaPlantFormDetails::LaPlantFormDetails(QWidget* parent, Qt::WFlags fl)
  : QDialog(parent,fl) 
{
...
LaPlantFormDetails::~LaPlantFormDetails()
{
  writeSettings();
}

void LaPlantFormDetails::readSettings()
{
...
void LaPlantFormDetails::writeSettings()
{
  QSettings mySettings;
...
void LaPlantFormDetails::on_pushButtonLoad_clicked()
{
  //
}

void LaPlantFormDetails::on_pushButtonSave_clicked()
{
  //
}

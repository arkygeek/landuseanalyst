...
################################################################################
## Form generated from reading UI file 'laReportHerds.ui'
##
...
class Ui_ModelTargets(object):
    def setupUi(self, ModelTargets):
        ...
        self.tblHerds = QTableWidget(self.splitter)
        if (self.tblHerds.columnCount() < 5):
            self.tblHerds.setColumnCount(5)
        __qtablewidgetitem = QTableWidgetItem()
        self.tblHerds.setHorizontalHeaderItem(0, __qtablewidgetitem)
        __qtablewidgetitem1 = QTableWidgetItem()
        self.tblHerds.setHorizontalHeaderItem(1, __qtablewidgetitem1)
        __qtablewidgetitem2 = QTableWidgetItem()
        self.tblHerds.setHorizontalHeaderItem(2, __qtablewidgetitem2)
        __qtablewidgetitem3 = QTableWidgetItem()
        self.tblHerds.setHorizontalHeaderItem(3, __qtablewidgetitem3)
        __qtablewidgetitem4 = QTableWidgetItem()
        self.tblHerds.setHorizontalHeaderItem(4, __qtablewidgetitem4)
        self.tblHerds.setObjectName(u"tblHerds")
        self.tblHerds.setAlternatingRowColors(True)
        self.tblHerds.setSelectionMode(QAbstractItemView.SingleSelection)
        self.tblHerds.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.splitter.addWidget(self.tblHerds)
    ...
    def retranslateUi(self, ModelTargets):
        ...
        ___qtablewidgetitem = self.tblHerds.horizontalHeaderItem(0)
        ___qtablewidgetitem.setText(QCoreApplication.translate("ModelTargets", u"Animal", None));
        ___qtablewidgetitem1 = self.tblHerds.horizontalHeaderItem(1)
        ___qtablewidgetitem1.setText(QCoreApplication.translate("ModelTargets", u"Animals/Year", None));
        ___qtablewidgetitem2 = self.tblHerds.horizontalHeaderItem(2)
        ___qtablewidgetitem2.setText(QCoreApplication.translate("ModelTargets", u"Adult Females", None));
        ___qtablewidgetitem3 = self.tblHerds.horizontalHeaderItem(3)
        ___qtablewidgetitem3.setText(QCoreApplication.translate("ModelTargets", u"Juveniles", None));
        ___qtablewidgetitem4 = self.tblHerds.horizontalHeaderItem(4)
        ___qtablewidgetitem4.setText(QCoreApplication.translate("ModelTargets", u"Food Required", None));
#if QT_CONFIG(tooltip)
        self.tblHerds.setToolTip(QCoreApplication.translate("ModelTargets", u"<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
...
"<p style=\" margin-top:0px; margin-bottom:0px; margin-left:0px; margin-right:0px; -qt-block-indent:0; text-indent:0px;\">Select a crop here to see and/or edit it's properties below.</p></body></html>", None))
        ...
        self.tblHerds.setWhatsThis(QCoreApplication.translate("ModelTargets", u"<html><head><meta name=\"qrichtext\" content=\"1\" /><style type=\"text/css\">\n"
"p, li { white-space: pre-wrap; }\n"
"</style></head><body style=\" font-family:'Sans Serif'; font-size:9pt; font-weight:400; font-style:normal; text-decoration:none;\">\n"

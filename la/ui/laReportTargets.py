...
# laReportTargets.py  from laReportTargets.ui
...
# IMPORTS:
from la.ui import laReportTargets


class laReportTargets(QWidget):
	def __init__(self, parent=None):
		super().__init__(parent=parent) # Call the inherited classes __init__ method
		self.ui = uic.loadUi("landuse_analyst/ui/laReportTargets.ui", self) # Load the .ui file

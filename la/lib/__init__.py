...
# la/lib/__init__.py
# This file can be used to import necessary modules or perform any setup required for the lib package

# Example: Importing qgis libs to set the correct sip api version
# import

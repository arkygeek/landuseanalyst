...
\end{figure}
    ...
    \begin{enumerate}
      ...
      part of the diet! ( See Fig. \ref{fig:dietCropDiagram} and Fig.
      \ref{fig:dietMeatDiagram}).
    \end{enumerate}
...
main areas.
  ...
  \textit{crop rotation} and the selection of \textit{suitability masks}.
    ...
    land along with the food value of the fallow land allows Landuse Analyst to
...
Two item which are worth further discussion are the Common and Specific Land options.
      \begin{enumerate}
        ...
        grazing by more than one type of animal. LandUse Analyst allows you to
        ...
        animals using it\footnote{A workaround for this problem is that LandUse
        Analyst produces classified maps of the land being used, so if it is
        ...
        LandUse Analyst allows you to designate a land suitability mask as

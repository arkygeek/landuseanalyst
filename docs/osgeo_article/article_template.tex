...
\section{Introduction} \label{sec:Introduction}
  ...
  Jordan Valley between the Dead Sea and Lake Tiberias.  The Jordan Valley is found
 in the Southern Levant, which is a name   commonly used to refer to the geographic
 region broadly described as   modern-day Israel, Palestine and Jordan. 
\begin{figure}[htbp] %Location
  \includegraphics[width=\textwidth]{./images/ShunaGoogleEarth3D.jpg}
...
\begin{figure}[htbp] %Proof of Concept
  \includegraphics[width=\textwidth]{./images/LanduseAnalyst544.jpg}
   % img42.jpg: 800x600 pixel, 72dpi, 28.22x21.17 cm, bb=0 0 800 600
...
\begin{figure}[htbp] %dietDiagram
  \includegraphics[width=\textwidth]{./images/dietDiagram.jpg}
...
\begin{figure}[htbp] %dietMeatDiagram
  \includegraphics[width=\textwidth]{./images/fancyDietMeat.jpg}
  % dietDiagram.jpg: 740x731 pixel, 72dpi, 26.10x25.78 cm, bb=0 0 740 731
...
\begin{figure}[htbp] %dietCropDiagram
  \includegraphics[width=\textwidth]{./images/dietFancyCrops.jpg}
...
\begin{figure}[htbp] %LADiet
  \includegraphics[width=\textwidth]{./images/LanduseAnalystDiet545.jpg}
...
\begin{figure}[htbp]
    \includegraphics[width=\textwidth]{./images/LanduseAnalystCrops546.jpg}
...
\begin{figure}[htbp]
  \includegraphics[width=\textwidth]{./images/cropManager.jpg}
...
\begin{figure}[htbp] %crop parameters
  \includegraphics[width=\textwidth]{./images/cropParameters.jpg}
...
\begin{figure}[htbp]
  \includegraphics[width=\textwidth]{./images/animalManager.jpg}
  % cropManager.jpg: 402x434 pixel, 762dpi, 1.34x1.45 cm, bb=0 0 38 41
...
\section{Land suitability raster masks} 
  ...
  \end{enumerate}
\begin{figure}[htbp] %Location
  \includegraphics[width=\textwidth]{./images/landcatchment.jpg}
  % img42.jpg: 800x600 pixel, 72dpi, 28.22x21.17 cm, bb=0 0 800 600
...
\begin{figure}[htbp] %Location
  \includegraphics[width=\textwidth]{./images/shunaTDN16LEB1P2000DR8020.jpg}
...
\address{Author 1\\ Address 1\\
\url{http://url1.com}\\
\email{email1@address.com}}

\address{Author 2\\ Address 2\\
\url{http://url2.com}\\

...
# laexperimentbase.py  from laexperimentbase.ui
...
# IMPORTS:
from landuse_analyst.ui import laexperimentbase


class laexperimentbase(QWidget):
	def __init__(self, parent=None):
		super().__init__(parent=parent) # Call the inherited classes __init__ method
		self.ui = uic.loadUi("landuse_analyst/ui/laexperimentbase.ui", self) # Load the .ui file

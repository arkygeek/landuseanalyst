...
# lagrassprocessbase.py from lagrassprocessbase.ui
...
# IMPORTS:
from landuse_analyst.ui import lagrassprocessbase


class lagrassprocessbase(QWidget):
	def __init__(self, parent=None):
		super().__init__(parent=parent) # Call the inherited classes __init__ method
		self.ui = uic.loadUi("landuse_analyst/ui/lagrassprocessbase.ui", self) # Load the .ui file

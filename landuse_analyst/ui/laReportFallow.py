...
# laReportFallow.py from laReportFallow.ui
...
# IMPORTS:
from landuse_analyst.ui import laReportFallow


class laReportFallow(QWidget):
	def __init__(self, parent=None):
		super().__init__(parent=parent) # Call the inherited classes __init__ method
		self.ui = uic.loadUi("landuse_analyst/ui/laReportFallow.ui", self) # Load the .ui file
